...
#SBATCH --time=2:00:00
#SBATCH -o output/slurm_logs/med-Polar-${NAME}.log
...
time torchrun --standalone --nproc_per_node=${NUM_GPUS} train_gpt_medium.py --mat_sign polar --name med-Polar-${NAME}  --num_iterations 100
EOF
